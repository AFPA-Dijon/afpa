...
/**
 * StudentsTestsFixture
 *
 */
class StudentsTestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'mat_key' => ['type' => 'index', 'columns' => ['student_id'], 'length' => []],
            'mat_key1' => ['type' => 'index', 'columns' => ['test_id'], 'length' => []],
        ],
        '_constraints' => [
